 ...
 * ARKDE version for adding a tab to encourage social login
	...
	<div id="register-page"class="page register-page">
		...
		<?php bp_nouveau_template_notices(); ?>
			...
			<form action="" name="signup_form" id="signup-form" class="standard-form signup-form clearfix" method="post" enctype="multipart/form-data">
                ...
                <div class="layout-wrap learndash-wrapper">

                    <?php if ( 'request-details' === bp_get_current_signup_step() ) : ?>

                    <?php bp_nouveau_signup_hook( 'before', 'account_details' ); ?>
                    <div class="ld-item-list ">
                        <div class="ld-item-list-items" data-ld-expand-list="true">
                            <div class="ld-item-list-item ld-expandable purple ld-item-lesson-item" id="register-tab-form">
                                <div class="ld-item-list-item-preview">
                                    
                                    <div class="ld-item-details">
                                        
                                        <div class="ld-expand-button ld-button-alternate" data-ld-expands="register-tab-form">
                                            <div class="ld-item-name " >
                                                O crea una cuenta manualmente <!--/.ld-item-title-->
                                            </div>
                                            <span class="ld-icon-arrow-down ld-icon is-medium"></span>
                                        </div> 
                                    </div>
                                </div> <!--/.ld-item-list-item-preview-->
                                <div class="ld-item-list-item-expanded">
                                    <div class="ld-table-list ld-topic-list ld-no-pagination" id="register-tab-form">
