    ...
    <div class="bb-grid grid">
        ...
        <div id="learndash-page-content">
            <div class="learndash-content-body">
                ...
                <div class="learndash_content_wrap content ">
                    ...
                    <?php
                        ...
                        if( $show_content ):
                        	...
                        	if( learndash_lesson_hasassignments($post) && !empty($user_id) ):
                                ...
                                //Because it has an assignment, by defaukt the mark complete button will not be show so
                                //let's show one by us
                                include locate_template('/learndash/ld30/lesson/arkde-mark-complete.php');
